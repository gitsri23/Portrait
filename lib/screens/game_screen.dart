        ...
        child: Row(
          ...
          children: [
            ValueListenableBuilder<int>(
              ...
              builder: (_, value, __) => Text("RUNS $value", style: const TextStyle(color: Color(0xFFC4E060), fontSize: 10, fontWeight: FontWeight.bold)),
            ),
            ValueListenableBuilder<int>(
              valueListenable: game.wicketNotifier,
              builder: (_, value, __) => Text("WKT $value", style: const TextStyle(color: Color(0xFFC4E060), fontSize: 10, fontWeight: FontWeight.bold)),
            ),
          ],
        ),
      ),
    ...
    return Positioned(
      ...
      child: Center(
        child: Container(
          ...
          child: Text(
            widget.leagueName,
            style: const TextStyle(color: Color(0xFFC4E060), fontSize: 10, fontWeight: FontWeight.bold),
          ),
        ),
      ),
    );
      ...
      body: Center(
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: const [BoxShadow(blurRadius: 30, color: Colors.black87, offset: Offset(0, 15))],
          ),
          child: Column(
            children: [
              const SizedBox(height: 10),
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      showDialog(
                        ...
                        builder: (_) => AlertDialog(
                          backgroundColor: const Color(0xFF8BAC0F),
                          title: const Text("PAUSED", style: TextStyle(color: Color(0xFF0F380F), fontWeight: FontWeight.bold)),
                          actions: [
                            TextButton(
                              onPressed: () {
                              ...
                              child: const Text("RESUME", style: TextStyle(color: Color(0xFF0F380F), fontWeight: FontWeight.bold)),
                            )
                          ],
                        ),
                      );
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: const BoxDecoration(
                        ...
                        boxShadow: [BoxShadow(color: Color(0xFF555555), offset: Offset(0, 4))],
                      ),
                      alignment: Alignment.center,
                      child: const Text("5", style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Color(0xFF333333))),
                    ),
                  ),
              ...
              const Row(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: [
                  Text("PAUSE", style: TextStyle(color: Colors.white54, fontSize: 10)),
                  Text("HIT", style: TextStyle(color: Colors.white54, fontSize: 12, fontWeight: FontWeight.bold)),
                  Text("EXIT", style: TextStyle(color: Colors.white54, fontSize: 10)),
                ],
              ),
